$(document).ready(function() {
                    ...
                    $.ajax({
                      ...
                      .done(function(plcResponse) {
                          ...
                          for (var i = 0; i < placesResults.length; i++) {
                            ...
                            var img1 = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference="+photoRef+"&key="+gApiKey; 
                            ...
                            if (i < 4) {
                              ...
                              /* ------------------------------------------- */
                               ...
                               // console.log("check way this: ", restaurants);
                               // endPlacesArray.push([restaurants]);
  ...
  function updateDB() {
    ...
    console.log("wy selection array: ", waySeleArray);

    for (var i = 0; i < waySeleArray.length; i++) {
      selections.food.waySelection[i] = waySeleArray[i];
    };

    for (var i = 0; i < endSeleArray.length; i++) {
      selections.food.endSelection[i] = endSeleArray[i];
    };

    console.log("obj: ", selections);

    // Upload the Road Trip food selectios data object into the database
