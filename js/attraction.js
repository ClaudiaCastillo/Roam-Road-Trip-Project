$(document).ready(function() {
  ...
  var eRadius = '50000';
  var eTypes  = 'attractions';
  var eMinPrice = '0';
  var eMaxPrice = '4';

  var wRadius = '50000';
  var wTypes  = 'attractions';
  var wMinPrice = '0';
  var wMaxPrice = '4';
                    ...
                    $.ajax({
                      ...
                      .done(function(plcResponse) {
                          ...
                          for (var i = 0; i < placesResults.length; i++) {
                            ...
                            if (i < 4) {
                              // Build the attractions Name DOM ID
                              var rNameId = "#ep-att-name-"+ [i+1];
                              $(rNameId).html(gName);

                              // Build the attractions Description DOM ID
                              var rDescription = '';
                              ...
                              // Build the attractions Price Level Sign
                              ...
                              var rDescriptionId = "#ep-att-desc-" + [i+1];
                              $(rDescriptionId).html(rDescription);
 
                              var rPhotoId = "#ep-att-img-" + [i+1];
                      ...
                      .done(function(plcResponse) {
                          ...
                          for (var i = 0; i < placesResults.length; i++) {
                            ...
                            if (i < 4) {
                              ...
                              var rDescriptionId = "#wp-att-desc-" + [i+1];
                              $(rDescriptionId).html(rDescription);

                              var rPhotoId = "#wp-att-img-" + [i+1];
                              // var parent = document.getElementById(rPhotoId);
  ...
  $(".wp-att-sel-2").click(function() {
    wpSummary();
  });
  $(".wp-att-sel-3").click(function() {
    wpSummary();
  });
  $(".wp-att-sel-4").click(function() {
    wpSummary();
  });
  $(".ep-att-sel-1").click(function() {
    epSummary();
  });
  $(".ep-att-sel-2").click(function() {
    epSummary();
  });
  $(".ep-att-sel-3").click(function() {
    epSummary();
  });
  $(".ep-att-sel-4").click(function() {
    epSummary();
  });
